                        ...
                        if (nextElement != -1 || (!line.contains("</g>") && !line.contains("</svg>"))) {
                            switch (nextElement) {
                                case -1: {
                                    Point previous = null;
                                    Point next = null;
                                    if (line.contains("<path d=\"")) {
                                        //M694.53 227.39L688.72 227.63M688.72 227.63L682.41 227.04M682.41 227.04L679.73 226.58M679.73 226.58L677.43 225.77
                                        line = line.substring(line.indexOf("<path d=\"") + 9);
                                        for (int i = 0; i < line.length(); i++) {
                                            if (line.charAt(i) == 'M') {
                                                int j = i + 1;
                                                for (; j < line.length(); j++) {
                                                    if (line.charAt(j) == 'M' || line.charAt(j) == 'L' || line.charAt(j) == '\"') {
                                                        break;
                                                    }
                                                }
                                                String[] p = line.substring(i+1, j).split(" ");
                                                if (p.length != 2) {
                                                    throw new RuntimeException(" parsing error");
                                                }
                                                previous = new Point(Double.parseDouble(p[0]), Double.parseDouble(p[1]));
                                                i=j-1;
                                                ...
                                                next = new Point(Double.parseDouble(p[0]), Double.parseDouble(p[1]));
                                                Line l = new Line(previous, next);
                                                tempLines.add(l);
                                                i=j-1;
                                                previous=next;
                                            }
                                        ...
                                        String stroke = line.substring(pos + 8, line.indexOf(" stroke-width", pos)-1);

                                        pos = line.indexOf(" stroke-width");
                                        String strokeWidth = line.substring(pos + 15, line.indexOf("\"/>", pos + 1));
                                ...
                                case 0: {
                                    ...
                                    pos = line.indexOf(";stroke-width:");
                                    c.strokeWidth = line.substring(pos + 14, line.indexOf(";", pos + 1));
                                    svg.addShape(c);
                                    break;
                                }
                                case 1: {
                                    ...
                                    pos = line.indexOf(";stroke-width:");
                                    l.strokeWidth = line.substring(pos + 14, line.indexOf(";", pos + 1));
                                    svg.addShape(l);
                                    break;
                                }
                                case 2: {
                                    ...
                                    pos = line.indexOf(";stroke-width:");
                                    pl.strokeWidth = line.substring(pos + 14, line.indexOf(";", pos + 1));
                                    svg.addShape(pl);
                                    break;
                                }
                                case 3: {
                                    ...
                                    pos = line.indexOf(";stroke-width:");
                                    arc.strokeWidth = line.substring(pos + 14, line.indexOf(";", pos + 1));
                                    svg.addShape(arc);
                                    break;
                                }
                                default: {
